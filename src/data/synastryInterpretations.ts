...
const SUN_SATURN: SynastryInterpretation[] = [
  ...
  },
  {
    ...
    marriageTip: 'Balance responsibility with joy - all work and no play dims the passion.',
    isPositive: false
  },
  {
    planets: ['sun', 'saturn'],
...
const SUN_URANUS: SynastryInterpretation[] = [
  ...
  },
  {
    ...
    marriageTip: 'Keep exploring new things together to maintain your passion.',
    isPositive: true
  },
  {
    planets: ['sun', 'uranus'],
