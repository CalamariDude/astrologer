...
const GRID_ITEMS = [
  ...
  { icon: '\u2600', title: 'Solar Return Overlay', description: 'Annual solar return chart displayed on the main wheel as an outer ring overlay.' },
  { icon: '\u263D', title: 'Lunar Return Overlay', description: 'Monthly lunar return displayed on the main wheel with prev/next navigation.' },
  ...
  { icon: '\u2B50', title: 'Astro.com & Astro-Seek Import', description: 'Paste from Astro.com or an Astro-Seek URL and import charts in seconds.' },
