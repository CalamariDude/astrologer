...
export const HOUSE_OVERLAY_BONUSES = [
  ...
  { planet: 'sun', house: 3, weight: 0.163, name: 'Sun in 3rd House', description: 'Core identity expressed through communication — the partner illuminates your thinking and ignites intellectual confidence' }, // 1.068x RFE:0.15
  ...
  { planet: 'uranus', house: 5, weight: 0.446, name: 'Uranus in 5th House', description: 'Exciting, unpredictable romance — keeps the passion alive through surprise, creativity, and unconventional expressions of love' }, // 1.248x RFE:0.41
