...
export function AuthModal({ isOpen, onClose, defaultTab = 'login' }: AuthModalProps) {
  ...
  const isEmailNotConfirmed = (error: string) =>
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-md bg-background rounded-xl shadow-2xl border overflow-hidden"
      ...
      >
        ...
        <div className="px-6 pt-6 pb-4">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {tab === 'login' ? 'Welcome back to Astrologer' :
             tab === 'signup' ? 'Create your Astrologer account' :
        ...
        {tab !== 'reset' && (
          <div className="px-6 flex gap-1 border-b">
            <button
              onClick={() => { setTab('login'); setUnconfirmedEmail(null); }}
            ...
            <button
              onClick={() => { setTab('signup'); setUnconfirmedEmail(null); }}
              className={`px-4 py-2 text-sm font-medium border-b-2 transition-colors ${
          ...
          {unconfirmedEmail && (
            <div className="rounded-lg border border-amber-500/30 bg-amber-500/10 p-3 space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Check your inbox for a confirmation link from Astrologer. If you didn't receive it, click below to resend.
              </p>
              <Button
                variant="outline"
                size="sm"
            ...
            <form onSubmit={handleLogin} className="space-y-3">
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full h-11 pl-10 pr-3 rounded-lg border bg-background text-sm"
                />
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full h-11 pl-10 pr-10 rounded-lg border bg-background text-sm"
                />
                <button
                  type="button"
